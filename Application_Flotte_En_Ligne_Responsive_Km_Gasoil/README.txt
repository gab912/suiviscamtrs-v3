...
VERSION RESPONSIVE + KM AUTO :
- Design plus sobre, sans menu latéral, plus proche de l’ancienne version.
- Responsive amélioré sur mobile/tablette.
- Parc camion : ajout du bouton "Actualiser km depuis tickets Gasoil".
- À chaque ticket Gasoil, le km actuel du camion est mis à jour avec le Km fin jour.
- Les tickets AdBlue ne changent pas le km actuel du parc camion.
